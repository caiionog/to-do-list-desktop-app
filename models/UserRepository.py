...
class UserRepository:
    ...
    def deletar_usuario(self, user_id: int) -> bool:
        ...
        Nota: Em um sistema real, a exclusão de um usuário deve primeiro
              remover/atribuir suas tarefas a outro usuário para evitar 
              problemas de chaves estrangeiras, ou usar CASCADE.
              Assumimos que as tarefas são tratadas pela lógica do Manager.
        """
        ...
        try:
            ...
            if cursor.rowcount > 0:
                ...
                return False # Nenhum usuário encontrado com esse ID
